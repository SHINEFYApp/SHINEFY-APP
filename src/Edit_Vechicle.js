      ...
      .then(obj => {
        if (obj.success == 'true') {
          ...
          this.setState({
            ...
            category_data_name: vehicle_arr.vehicle_name[config.language],
            category_data_img: vehicle_arr.vehicle_image,
            category_data_id: vehicle_arr.car_category_id,
            make_data_name: vehicle_arr.make_name[config.language],
            make_data_img: vehicle_arr.make_image,
            make_data_id: vehicle_arr.make_id,
            color_name: vehicle_arr.color_name[config.language],
            color_code: vehicle_arr.color_code,
            color_id: vehicle_arr.color_id,
            modal_name: vehicle_arr.model_name[config.language],
            modal_id: vehicle_arr.model_id,
            plate_number: vehicle_arr.plate_number,
          });
        } else {
          msgProvider.alert(
            Lang_chg.information[config.language],
            ...
            <View
              ...
              <View
                ...
                <Text
                  ...
                  {Lang_chg.editvechile_txt[config.language]}
                </Text>
              </View>
            </View>
          </ImageBackground>
          <KeyboardAwareScrollView
            ...
            <ImageBackground
              ...
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => {
                  this.setState({car_modal_modal: !this.state.car_modal_modal}),
                    this.SearchModel('');
                }}
                style={{
                  width: (mobileW * 90) / 100,
