...
class Language_provider {
  ...
  add_another_vehicle = ['Add New Vehicle', 'أضف سيارة جديدة'];
  ...
  carsCount_txt = ['Count Of Cars', ' عدد السيارات'];
  ...
  cars_text = ['Change in plans', 'التغيير في الخطط'];
  ...
  basicTerms = [
    ...
    'المصطلحات الأساسية المتعلقة بالمحتوى:',
  ];
  terms4 = [
  ...
  licences = [
    ...
    'التراخيص التي تمنحها الشركة لمحتوى الشركة ومحتوى المستخدم.',
  ];
  terms12 = [
  ...
  copyRightPolicy = ['Copyright policy', 'سياسة حقوق النشر'];
  terms27 = [
  ...
  behaviourAds = [
    'Targeted or behavioral ads',
    'الإعلانات المستهدفة أو السلوكية',
  ];
  ...
  policy30 = [
    '(SHINEFY) P.O. Box () Cairo Postal Code ()',
    '(شينفي) ص.ب. صندوق () الرمز البريدي للقاهرة ()',
  ];

  policy31 = [
    'Our contact: (info@ SHINEFY.co).',
    'جهة الاتصال لدينا: (info@SHINEFY.co).',
  ];
}
