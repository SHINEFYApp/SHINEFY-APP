...
class messageTextProvider {
  ...
  newmatchPassword = [
    ' New Password or confirm password doesn' + "'" + 't match.',
  ];
  ...
  emptyStarttime = [
    ...
    'Por favor seleccione hora de inicio',
  ];
  emptyEndtime = [
    'Please select end time',
    'Por favor seleccione hora de finalización',
  ];

  emptyComment = ['Please enter comment', 'Por favor ingrese un comentario'];
  emptyServicerate = [
    'please enter service rate',
    'por favor ingrese la tarifa del servicio',
  ];
  ...
  emptyReactual_two = [
    'Please enter regactual two',
    'Por favor ingrese el actual dos',
  ];
  emptyDescription = [
  ...
  ValidView = [
    'If you select add,edit,delete then view is compulsory',
    'Si selecciona agregar, editar, eliminar, la vista es obligatoria',
  ];
}
