...
export default async function updateVehicle(currentCar) {
  ...
  fd.append(
    'car_category_id',
    currentCar.car_category ? currentCar.car_category.car_category_id : 'NA',
  );
  fd.append('model_id', currentCar.modal ? currentCar.modal.model_id : 'NA');
  fd.append(
    'make_id',
    currentCar.car_make ? currentCar.car_make.make_id : 'NA',
  );
  fd.append(
    'color_id',
    currentCar.car_color ? currentCar.car_color.color_id : 'NA',
  );
