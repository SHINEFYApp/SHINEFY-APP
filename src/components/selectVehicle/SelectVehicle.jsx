...
export default function SelectVehicle ({car ,selected , onPress}) {
    return (
        <TouchableHighlight underlayColor={"white"}  onPress={()=>{
            ...
            <View  className={`${car.vehicle_id === selected ? "bg-mainColor" : "bg-white"} ${!onPress && "w-full justify-evenly"} mx-1 rounded-xl p-2 flex-row self-baseline items-center`} style={globalStyle.boxShadow}>
                <View className="items-center pr-2 border-r border-[#ccc] mr-5">
                    ...
                    <Image source={img} className={!onPress && "w-[150] h-[150]"} resizeMode="contain"/>
                </View>
