            ...
            <ImageBackground
              ...
              {this.state.login_type == 'app' && (
                <TouchableOpacity
                  ...
                  <View
                    style={{width: '10%', paddingTop: (mobileW * 0.7) / 100}}>
                    <Image
              ...
              <TouchableOpacity
                activeOpacity={1}
                onPress={() => {
                  this.setState({modalstate: 2, modalVisible: true});
                }}
                style={{
                  width: (mobileW * 92) / 100,
                  alignSelf: 'center',
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  this.setState({modalstate: 1, modalVisible: true});
                }}>
                <View style={{width: '10%', paddingTop: (mobileW * 0.7) / 100}}>
                  <Image
